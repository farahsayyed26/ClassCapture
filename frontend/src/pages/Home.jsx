    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 font-sans text-brand-dark overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full bg-white/70 backdrop-blur-lg border-b border-brand-light/20 z-50 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 font-medium text-brand-muted text-sm">
            <a href="#how-it-works" className="text-brand-dark font-semibold text-sm hover:text-brand-main transition no-underline">How It Works</a>
            <a href="#features" className="text-brand-dark font-semibold text-sm hover:text-brand-main transition no-underline">Features</a>
            <a href="#reviews" className="text-brand-dark font-semibold text-sm hover:text-brand-main transition no-underline">Reviews</a>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto bg-brand-main rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden">
          ...
          <button 
            onClick={() => navigate(user ? '/dashboard' : '/login')}
            className="bg-white text-brand-main px-12 py-4 rounded-full font-bold text-lg hover:bg-brand-dark hover:text-black transition-all shadow-2xl relative z-10"
          >
